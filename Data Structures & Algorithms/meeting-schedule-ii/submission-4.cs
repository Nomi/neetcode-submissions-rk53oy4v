...
public class Solution {
    public int MinMeetingRooms(List<Interval> intervals) {
        return 
                ...
                // Attempt2_SweepLine_OrderedMapVersion_MicroOptimizedForSpace
            (intervals);
    }
    ...
    public int Attempt2_SweepLine_OrderedMapVersion_MicroOptimizedForSpace_AlsoHardToModifyForDifferentBoundInclusivities(List<Interval> intervals) {
        //min number of rooms == maximum overlap
