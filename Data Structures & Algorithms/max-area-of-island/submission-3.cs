...
public class NuAttempt1 {
    ...
    public int GetCurIslandAreaBFS(int[][] grid, int r, int c) //assumess r,c is a valid island
    {
        ...
        //*IMPORTANT* FOR EARLY MARKING/TRACKING
        // WE NEED TO PROCESS AS SOON AS IT IS ADDED TO QUEUE/
        // SO WE MARK VISITED AND INCREMENT AREA EVERYTIME WE ENQUEUE (INCLUDING FOR STARTING CELL(S))
