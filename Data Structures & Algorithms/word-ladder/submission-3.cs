public class Solution {
    ...
    public int LadderLength(string beginWord, string endWord, IList<string> wordList) {
        ...
        return FindMinDistance_Modular(beginQ, endQ, wildcardMap);
    }
    ...
    private int FindMinDistance_Modular(Queue<string> beginQ, Queue<string> endQ, Dictionary<string, List<string>> wildcardMap) {
        Dictionary<string, int> distBegin = new();
        Dictionary<string, int> distEnd = new();
