// For interview: stick to single BFS from start. 
// At most will need to explain in follow-up this bi-directional BFS, but not write the code, most probably (unless you're a senior).
