...
// 5. The error was accessing cell with board[r][board.Length-1] in first loop (over the vertical edges) AND 
...
// 4. Total Time Taken: ~33 minutes (approx)

public class NuAttempt1_MsBfs : ISurroundedRegionsSolver {
    const char O = 'O';
    const char X = 'X';
    const char UnflippableO = '\0';
