...
// ## Notes:
// - I learned DSU Theoretically a couple days ago (if I ever learned it before, it had to be approx. ~1.5 years ago).
// - I did write the structure down on my notebook back then (using C#)!
// - *IMPORTANT* I do NOT think I could think of the `E == V-1` TRICK, read it a few days back when researching Union Find!!
// ## *IMPORTANT* NIFTY TRICKS:
// - For TREES: `E == V-1` ALWAYS!      [I do NOT think I could think of it by myself, read it a few days back when researching Union Find!!]
// ## Time Taken:
...
// = 28-ish minutes
// + a few minutes improving things according to AI feedback!
// ## Complexities:
...
public class NuAttempt1_Dsu_BySize_PathCompression : IGraphValidTree{
    // IN GRAPH THEORY: an N-ary tree is a Connected, Undirected, and Acyclic graph with each vertex/node having at most N children.
