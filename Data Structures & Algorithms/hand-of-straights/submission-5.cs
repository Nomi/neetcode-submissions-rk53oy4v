public class Solution {
    public bool IsNStraightHand(int[] hand, int groupSize) {
        // 14-06-26 Update: IMP! Would be better to subtract by total number of cards of the startOfGroup and if anywhere it becomes negative, return false.
        // ^ That MUST USE involving sorting keys of the dict to get the ascending sorted UNIQUE cards, 
        // so we NEVER MISS CARDS THAT ARE START OF A SERIES BUT ALSO PART OF ANOTHER.
