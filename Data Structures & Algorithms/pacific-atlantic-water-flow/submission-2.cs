...
public class NuAttempt1_Bfs : IPacificAtlanticWaterflowSolver {
    // ### Time taken:
    // IMPORTANT NOTE: I was very sleepy and tired when I coded this. It's a miracle I coded this up. Thankfully, I had designed the algorithm exactly yesterday already (my conversation with AI as not a help but as a pseudo interviewer, instructed to be vague and conservative with any hints, and to not give me the solution)
