public class Solution {
    ...
    public List<int> PartitionLabels(string s) { // Kind of like `intervals` :)
        ...
        //Micro Optimization:        // for(int i = s.Length-1; i >= 0; i--) {        //     lastIdx.TryAdd(s[i], i);        //     if(lastIdx.Count == LowerCaseEnglishLetterCount) break; //Only works if all chars in string!        // }
